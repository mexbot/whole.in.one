...
#define STRING_VERSION_CONFIG_H __DATE__ " 12.7.15" __TIME__ // build date and time
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {98.6525505,109.613945,1266.68616,719.2}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {200, 200, 10, 45}//{250, 250, 3.3, 25}    // (mm/sec)
...
// For the other hotends it is their distance from the extruder 0 hotend.
 #define EXTRUDER_OFFSET_X {0.0, 40.85} // (in mm) for each extruder, offset of the hotend on the X axis
