...
static void lcd_preheat()
{
    ...
    setTargetHotend1(PREHEAT_HOTEND_TEMP);
...
#if MOTHERBOARD == 33 || MOTHERBOARD == 34 || MOTHERBOARD == 35 || MOTHERBOARD == 80//-------------------------------mensaje 1----------------------------------------------
    lcd.clear();
    
    lcd.setCursor(6, 0);
    lcd_printPGM(PSTR("Mex-Bot"));
    lcd.setCursor(1, 1);
    lcd_printPGM(PSTR("imprenta y fabrica"));
    lcd.setCursor(5, 3);
    lcd_printPGM(PSTR("iniciando....."));
  
    delay(1500);
    lcd.clear();
    //-------------------------------mensaje 2----------------------------------------------
     lcd.setCursor(3, 1);
    lcd_printPGM(PSTR("Whole in One"));
     delay(1500);
    lcd.clear();
#endif
