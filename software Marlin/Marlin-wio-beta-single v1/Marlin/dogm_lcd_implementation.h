...
static void lcd_implementation_init()
{
	...
	do {
			// RepRap init bmp
			//u8g.drawBitmapP(0,0,START_BMPBYTEWIDTH,START_BMPHEIGHT,start_bmp);  //---------dibujo de reprap
			// Welcome message
			u8g.setFont(u8g_font_6x10_marlin);
			u8g.drawStr(12,14,"    Mex-Bot"); 
			u8g.setFont(u8g_font_5x8);
			u8g.drawStr(12,22,"imprenta y fabrica");
			u8g.setFont(u8g_font_6x10_marlin);
			u8g.drawStr(62,28," ");
			u8g.drawStr(12,41,"Prusa i3-V4");
			u8g.setFont(u8g_font_5x8);
			u8g.drawStr(12,48,"");
			u8g.setFont(u8g_font_5x8);
			u8g.drawStr(12,50,"by RABV");
			u8g.drawStr(12,61,"  E-BOT 3Dprinting");
